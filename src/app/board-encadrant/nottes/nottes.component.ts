...
@Component({
  selector: 'app-nottes',
  templateUrl: './nottes.component.html',
  styleUrls: ['./nottes.component.css']
})
export class NottesComponent implements OnInit {
  stages: any;
  ...
  display = false ;
  onupdateprod() {
    this.us.noteEnc( this.currentprod.id, this.currentprod.note_univ).
